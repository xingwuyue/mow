      ...
      _export("PlayerHealthBar", PlayerHealthBar = (_dec = ccclass('PlayerHealthBar'), _dec(_class = class PlayerHealthBar extends Component {
        ...
        start() {
          ...
          if (playerNode) {
            ...
            var combatNodes = playerNode.children.filter(child => child.getComponent(_crd && PlayerCombat === void 0 ? (_reportPossibleCrUseOfPlayerCombat({
              error: Error()
        ...
        update() {
          if (this._playerCombat && this._progressBar) {
            var currentHealth = this._playerCombat.health;
