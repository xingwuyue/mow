    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property({
        ...
        onLoad() {
          ...
          // 获取地图节点
          const mapNode = (_this$node$parent = this.node.parent) == null ? void 0 : _this$node$parent.getChildByName('map');
        ...
        spawnSingleEnemy() {
          ...
          const enemyComp = enemy.getComponent(_crd && Enemy === void 0 ? (_reportPossibleCrUseOfEnemy({
            error: Error()
          }), Enemy) : Enemy);
